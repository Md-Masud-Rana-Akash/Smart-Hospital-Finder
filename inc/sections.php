...
<section id="about">
    ...
    <div class="col-sm-12 col-md-6">
        ...
        <p>We are not any specific hospital that you are looking for rather we make it easy for you that rhich hospital or clicnic or doctor you are looking for using this website , you can get the neccessary information in detail's about your desired hospital or clicnic or doctor</p>
        <a href="about_more.php" class="btn btn-success">Read More</a> <br> <br>  <br>

        <h3 class="btn btn-primary btn-lg">OUR VISION & MISSION</h3>
        <p>We are commited to provide valuable and accurate service to our visitors and customer's who regularly use our site to get latest update , our mission and vision is to provide quality service both nationally and internationally.</p>
...
<p>The owner of any clicnic or private hospital can add their information to our site so that user can get their desirable information through out this from anywhere in the count</p>
</div>
</div>
</div>
            ...
            <div class="col-sm-3"> 
                <div class="map">
                   <button type="button" class="btn btn-success">Google Map</button>
                    <div id="map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.4016169203146!2d90.42351411435888!3d23.768708793994882!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c7894ad2a21d%3A0xbb20a6f3fc4db34a!2sEast+West+University+(EWU)!5e0!3m2!1sen!2sbd!4v1511536482120"
                     width="300"
                      height="250"
                       frameborder="0"
                        style="border:0"
